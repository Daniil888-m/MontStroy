...
$(function () {
	...
	$('.partners__slider').slick({
		slidesToShow: 4,
		arrows: true,
		prevArrow: $('.partners__arrows_prev'),
		nextArrow: $('.partners__arrows_next'),
		responsive: [
			{
				breakpoint: 1132,
				settings: {
	...
	window.addEventListener('resize', function () {
		if (document.documentElement.clientHeight < 720) {
			document.querySelector('ymaps').style.height = '450px';

		}
	})

	let maps = setInterval(function () {
		if (document.querySelector('ymaps')) {
			if (document.documentElement.clientHeight < 720) {
				document.querySelector('ymaps').style.height = '50vh';
				clearTimeout(maps);
	...
	let ourParallax = document.getElementById('scene');
